    ...
    if (!$errors) {
        try {
            if ($editing && $article) {
                ...
                // INSERT novog članka
                $stmt = $pdo->prepare("
                    INSERT INTO articles (slug, title, excerpt, content, image, category, tags, created_at)
                    VALUES (:slug, :title, :excerpt, :content, :image, :category, :tags, :created_at)
                ");
                      ...
                      <?php foreach ($allArticles as $row): ?>
                        <tr>
                          ...
                          <td class="d-flex gap-1">
                            <a href="admin-novosti.php?id=<?= (int)$row['id'] ?>"
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="slug" id="slug" class="form-control"
                            placeholder="npr. europsko-prvenstvo-2025"
